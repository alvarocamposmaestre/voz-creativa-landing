...
description: Provides the single source of truth for brand guidelines, design tokens, technology choices, and voice/tone. Use this skill whenever generating UI components, styling applications, writing copy, or creating user-facing assets to ensure brand consistency for ProjectPilot.
---

# Brand Identity & Guidelines

**Brand Name:** ProjectPilot
...
### For Advanced UI/UX & Aesthetic Intelligence
If you need to generate high-end, modern, and "gorgeous" interfaces using patterns like Bento Grid, Aurora UI, or Glassmorphism, consult:
👉 **[`resources/ui-ux-intelligence.md`](resources/ui-ux-intelligence.md)**
